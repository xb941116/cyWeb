...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>${pager.params.bizNo}广告管理</title>
...
<!--页面标头start-->
<div class="ctabs">
    <a href="#">${pager.params.bizNo}广告管理</a>
...
<div class="container-fluid">
    <div class="info-center">
        <!--页面标头end-->
        <form class="ajax_form validate" method="post" action="${ctx}/biz/bizAd/createPaySucess" id="theForm" novalidate="novalidate">
            <!--操作栏start-->
