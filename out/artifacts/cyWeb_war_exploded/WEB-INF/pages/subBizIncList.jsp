...
<section class="mart2b2">
    ...
    <div class="selec-list clearfix body-bg">
        ...
        <table class="selec-list-table">
            <tr><%--修改人：苏方宁  时间：18-03-15--%>
                <td  width="13%" class="tr_bg1">商家</td>
                <td width="13%" class="tr_bg2">微信收入</td>
				<td width="13%" class="tr_bg2">钱包收入</td>
                <td width="13%" class="tr_bg2">积分收入</td>
                <td width="13%" class="tr_bg2">投币收入</td>
                <td width="13%" class="tr_bg2">刷卡收入</td>
                <td width="13%" class="tr_bg2">总收入</td>
                <td width="13%" class="tr_bg3">设备在线</td>
            </tr>
            <c:forEach items="${pager.recordList}" var="biz">
                <tr><%--修改人：苏方宁  时间：18-03-15--%>
                    <td width="10%">${fn:substring(biz.name,0,7)}</td>
                    <td width="10%">${biz.netInc}</td>
					<td width="10%">${biz.wltInc}</td>
                    <td width="10%">${biz.coinsInc}</td>
                    <td width="10%">${biz.coinInc}</td>
                    <td width="10%">${biz.cardInc}</td>
                    <td width="10%">${biz.totalInc}</td>
                    <td width="10%">${biz.online}</td>
                </tr>
            </c:forEach>
        </table>
        <section class="fc">
