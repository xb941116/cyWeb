    ...
    <form method="post" class="ajax_form validate" novalidate="novalidate" id="form">
        <table class="table table-bordered  table-header table-hover margin-top">
            ...
            <tr>
                ...
                <td>
                    <input name="coin" id="coin" type="text" class="form-control" style="width: 300px;" required data-original-title="" title="">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input name="money" id="money" type="text" class="form-control" style="width: 300px;" required data-original-title="" title="">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input name="totalMbr"id="totalMbr" type="text" class="form-control" style="width: 300px;" required data-original-title="" title="">
                </td>
            </tr>
            <tr>
                <td align="right"><span class="C_ss">*</span>
                ...
                <td>
                    <input name="totalAll"id="totalAll" type="text" class="form-control" style="width: 300px;" required data-original-title="" title="">
                </td>
            </tr>
            <tr>
                <td align="right"><span class="C_ss">*</span>
                ...
                <td>
                    <input name="sort" type="text" class="form-control" style="width: 300px;" required data-original-title="" title="">
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <label class="margin-right"><input type="radio" value="0" name="state" data-original-title="" title="" >否</label>
                    <label class="margin-right"><input type="radio" value="1" name="state" data-original-title="" title="" checked="true" >是</label>
                </td>
            </tr>
            <tr>
                <td align="right"><span class="C_ss">*</span>
