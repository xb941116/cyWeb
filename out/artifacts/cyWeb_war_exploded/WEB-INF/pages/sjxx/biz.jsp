    ...
    <div class="left-main left-full">
        ...
        <div class="subNavBox">
            <div class="sBox" data-pid="30" data-id="36" style="display: block;">
                <div class="subNav sublist-up"><span class="title-icon glyphicon glyphicon-chevron-up"></span><span class="sublist-title">商家管理</span></div>
                <ul class="navContent" style="display: block;">
                    ...
                    <c:if test="${isAdmin}">
                        <li>
                            <div class="showtitle" style="display: none;"><img src=""></div>
                            <a href="${ctx}/biz/queryAd" target="main"><span class="sublist-icon glyphicon glyphicon-minus"></span><span class="sub-title"><i class="icon iconfont"></i>广告管理</span></a>
                        </li>
                    </c:if>
                    <c:if test="${isShowAd}">
                        <li>
                            <div class="showtitle" style="display: none;"><img src=""></div>
                            <a href="${ctx}/biz/adSet" target="main"><span class="sublist-icon glyphicon glyphicon-minus"></span><span class="sub-title"><i class="icon iconfont"></i>广告设置</span></a>
                        </li>
                    </c:if>.
                </ul>
            </div>
